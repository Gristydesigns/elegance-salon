...
-   The salon is updating their images in-line with their new skills and abilities. So, the websites need to showcase these. Each image is there to inspire and show off the professionalism of the salon. As stated by their new strapline ’Setting the trend’; this has already been tested out as other salons are following Elegance strategies. Imagery is important to engage clients on site and so I need to as a developer place these well to have the wow factor, so they stay on site until they access the service.
...
-   Google was used for stylizing the website fonts as it gave me a great selection to choose from.

* [Web](https://developers.google.com/web/fundamentals/native-hardware/click-to-call/) Fundamentals

-   Affinity photo - I used this product to crop images
-   Microsoft Word - draft README file.
-   Web fundamentals – this was used for telephone number link. Adding meta data so modern mobiles browser automatically detect phone numbers and enable click to call. Mobile safari automatically converts phone numbers to links with the associated hyperlink style.
...
* This project was developed using AWS Cloud9. The data is stored in git using the AWS Cloud9 platform.

* The project was regularly pushed to GitHub repository [https://gristydesigns.github.io/elegance-salon/](https://gristydesigns.github.io/elegance-salon/) and published to GitHub pages using the GitHub settings.

**Deployment to Github**

* I used and configured GitHub Pages to publish my site's source files from my master branch folder named Elegance.
...
-   Used git status when checking what needed uploading.
-   I used the command -add git . to add to my git.
